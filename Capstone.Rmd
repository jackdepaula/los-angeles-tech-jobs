...
occupation$industry <- fct_reorder(occupation$industry, occupation$median_wages17, mean, na.rm=TRUE)# The function takes four parameters: 
...
ggplot(data=occupation, mapping=aes(x=industry, y=perchange206, fill=compu)) +
  stat_summary(fun.y=mean, geom="bar") +
  scale_y_continuous() +
  labs(title="Employment Percenatage Growth Projection by Industry 2016-2026 ", x="", y="") + 
  coord_flip() +
  theme(legend.position="none") +
  scale_fill_manual(values=mycols) +
